...
import com.example.blackcar.databinding.FragmentDriverStatsBinding;
import com.example.blackcar.data.api.model.RideStatsDayDto;
import com.example.blackcar.data.api.model.RideStatsResponse;
import com.example.blackcar.presentation.stats.viewmodel.DriverStatsViewModel;
...
public class DriverStatsFragment extends Fragment {
    ...
    private FragmentDriverStatsBinding binding;
    private DriverStatsViewModel viewModel;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentDriverStatsBinding.inflate(inflater, container, false);
        viewModel = new ViewModelProvider(this).get(DriverStatsViewModel.class);

        binding.editDateFrom.setText(DriverStatsViewModel.getDefaultDateFrom());
        binding.editDateTo.setText(DriverStatsViewModel.getDefaultDateTo());
